...
For this reason an extra script is copied across all servers and user. This script helps in
copying the files across the server once the path is specified
